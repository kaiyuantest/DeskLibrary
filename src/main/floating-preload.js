...
contextBridge.exposeInMainWorld('deskLibraryFloating', {
  ...
  openMainWindowRecordDetail: (payload) => ipcRenderer.invoke('open-main-window-record-detail', payload),
  ...
  searchRecords: (payload) => ipcRenderer.invoke('floating-search-records', payload),
  searchAssets: (payload) => ipcRenderer.invoke('floating-search-assets', payload),
